...
import ua.study.english.other.AdapterStudyLeft.ViewHolder;
...
public class AdapterStudyRight extends BaseAdapter{
	
	static Context mContext;
    static ArrayList<WordTranslEnt> word_List;
	  LayoutInflater mInf;
	  ViewHolder vh1;
	//відповідає за відображення правої колонки на екрані слів
    public AdapterStudyRight(Context context, ArrayList<WordTranslEnt> list){
 	...
 	public View getView(final int position, View convertView, ViewGroup parent) {
 		 final ViewHolder vh1;
 		   ...
 		   vh1.item_word.setText(word_List.get(position).getTranslate());
 		   return convertView;
 	}	
